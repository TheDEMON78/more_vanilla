...
public class SbirebossenderiteEntity extends Zombie {
	public SbirebossenderiteEntity(EntityType<SbirebossenderiteEntity> type, Level world) {
		super(type, world);
		xpReward = 1;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, EnderDragon.class, false, false));
	}
