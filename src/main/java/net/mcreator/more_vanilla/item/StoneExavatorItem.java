...
import net.mcreator.more_vanilla.procedures.StoneExavatorQuandLobjetEstFabriquefonduProcedure;

public class StoneExavatorItem extends ShovelItem {
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		StoneExavatorQuandLobjetEstFabriquefonduProcedure.execute(entity);
	}
