...
import net.mcreator.more_vanilla.procedures.IronExavatorQuandLobjetEstFabriquefonduProcedure;

public class IronExavatorItem extends ShovelItem {
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		IronExavatorQuandLobjetEstFabriquefonduProcedure.execute(entity);
	}
