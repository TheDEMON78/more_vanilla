...
import net.mcreator.more_vanilla.procedures.EmeraldexavatorLorsqueLoutilEstDansLaMainProcedure;

public class EmeraldexavatorItem extends ShovelItem {
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		EmeraldexavatorLorsqueLoutilEstDansLaMainProcedure.execute(entity);
	}
