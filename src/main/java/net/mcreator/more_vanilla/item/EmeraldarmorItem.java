...
public abstract class EmeraldarmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(new ItemStack(Items.EMERALD)), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("more_vanilla:emerald_"))), 2f, 0f);
			registerHelper.register(ResourceLocation.parse("more_vanilla:emeraldarmor"), armorMaterial);
