...
import net.mcreator.more_vanilla.procedures.SapphireexavatorLorsqueLoutilEstDansLaMainProcedure;
import net.mcreator.more_vanilla.init.MoreVanillaModItems;

public class SapphireexavatorItem extends ShovelItem {
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		SapphireexavatorLorsqueLoutilEstDansLaMainProcedure.execute(entity);
	}
