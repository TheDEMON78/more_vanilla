...
import net.mcreator.more_vanilla.procedures.EnderiteExavatorQuandLobjetEstFabriquefonduProcedure;
import net.mcreator.more_vanilla.init.MoreVanillaModItems;

public class EnderiteExavatorItem extends ShovelItem {
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		EnderiteExavatorQuandLobjetEstFabriquefonduProcedure.execute(entity);
	}
