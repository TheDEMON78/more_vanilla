...
import net.mcreator.more_vanilla.procedures.DiamondExavatorQuandLobjetEstFabriquefonduProcedure;

public class DiamondExavatorItem extends ShovelItem {
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		DiamondExavatorQuandLobjetEstFabriquefonduProcedure.execute(entity);
	}
