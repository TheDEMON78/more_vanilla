...
import net.mcreator.more_vanilla.procedures.RubyexavatorLorsqueLoutilEstDansLaMainProcedure;
import net.mcreator.more_vanilla.init.MoreVanillaModItems;

public class RubyexavatorItem extends ShovelItem {
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		RubyexavatorLorsqueLoutilEstDansLaMainProcedure.execute(entity);
	}
