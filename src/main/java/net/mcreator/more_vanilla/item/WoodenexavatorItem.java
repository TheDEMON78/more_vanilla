...
import net.mcreator.more_vanilla.procedures.WoodenexavatorQuandLobjetEstFabriquefonduProcedure;
import net.mcreator.more_vanilla.procedures.WoodenexavatorQuandLeBlocEstDetruitAvecLoutilProcedure;

public class WoodenexavatorItem extends ShovelItem {
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		WoodenexavatorQuandLobjetEstFabriquefonduProcedure.execute(entity);
	}
