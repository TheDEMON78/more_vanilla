...
import net.mcreator.more_vanilla.procedures.NetheriteExavatorQuandLobjetEstFabriquefonduProcedure;

public class NetheriteExavatorItem extends ShovelItem {
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		NetheriteExavatorQuandLobjetEstFabriquefonduProcedure.execute(entity);
	}
