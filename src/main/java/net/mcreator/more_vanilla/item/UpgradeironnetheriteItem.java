...
import net.mcreator.more_vanilla.procedures.UpgradeironnetheriteQuandLobjetEstFabriquefonduProcedure;
import net.mcreator.more_vanilla.init.MoreVanillaModItems;

public class UpgradeironnetheriteItem extends ShovelItem {
	...
	public UpgradeironnetheriteItem() {
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		UpgradeironnetheriteQuandLobjetEstFabriquefonduProcedure.execute(entity);
	}
