...
import net.mcreator.more_vanilla.procedures.GoldenExavatorQuandLobjetEstFabriquefonduProcedure;

public class GoldenExavatorItem extends ShovelItem {
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		GoldenExavatorQuandLobjetEstFabriquefonduProcedure.execute(entity);
	}
