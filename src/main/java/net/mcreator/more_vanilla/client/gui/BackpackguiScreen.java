package net.mcreator.more_vanilla.client.gui;
...
public class BackpackguiScreen extends AbstractContainerScreen<BackpackguiMenu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("more_vanilla:textures/screens/backpackgui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.more_vanilla.backpackgui.label_end_barel"), 6, 5, -16777216, false);
	}
