package net.mcreator.more_vanilla.world.features;
...
import net.mcreator.more_vanilla.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(Registries.FEATURE, MoreVanillaMod.MODID);
