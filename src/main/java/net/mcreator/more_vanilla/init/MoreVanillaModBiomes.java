...
@EventBusSubscriber
public class MoreVanillaModBiomes {
	@SubscribeEvent
			...
			if (dimensionType == dimensionTypeRegistry.getOrThrow(BuiltinDimensionTypes.OVERWORLD)) {
				...
				if (chunkGenerator.getBiomeSource() instanceof MultiNoiseBiomeSource noiseSource) {
					...
					addParameterPoint(parameters,
							new Pair<>(new Climate.ParameterPoint(Climate.Parameter.span(-0.02f, 0.02f), Climate.Parameter.span(-0.02f, 0.02f), Climate.Parameter.span(0.49f, 0.53f), Climate.Parameter.span(0.78f, 0.82f), Climate.Parameter.point(0.0f),
									Climate.Parameter.span(-0.5374209301f, -0.4974209301f), 0), biomeRegistry.getHolderOrThrow(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("more_vanilla", "upgradebiome")))));
					addParameterPoint(parameters,
				...
				if (chunkGenerator instanceof NoiseBasedChunkGenerator noiseGenerator) {
					...
					if (currentRuleSource instanceof SurfaceRules.SequenceRuleSource sequenceRuleSource) {
						...
						addSurfaceRule(surfaceRules, 1, preliminarySurfaceRule(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("more_vanilla", "upgradebiome")), Blocks.GRASS_BLOCK.defaultBlockState(),
